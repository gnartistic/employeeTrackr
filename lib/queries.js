...
function insertIntoEmployees(string, decimal, integer, manager_integer) {
...
module.exports = { selectedDepartment, insertIntoDepartments, selectedRoles, insertIntoRoles, selectedEmployees, insertIntoEmployees, updateEmployees}